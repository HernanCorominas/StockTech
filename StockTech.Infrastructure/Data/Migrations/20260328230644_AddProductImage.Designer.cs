...
namespace StockTech.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260328230644_AddProductImage")]
            ...
            modelBuilder.Entity("StockTech.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 3, 28, 23, 6, 42, 663, DateTimeKind.Utc).AddTicks(6371),
                            Description = "Productos de cuidado personal y belleza",
                            IsActive = true,
                            Name = "Belleza",
                            UpdatedAt = new DateTime(2026, 3, 28, 23, 6, 42, 663, DateTimeKind.Utc).AddTicks(6376)
                        },
                        new
                        {
                            Id = new Guid("fa2f082d-72a2-b281-0081-8b9cad0e1f20"),
                            CreatedAt = new DateTime(2026, 3, 28, 23, 6, 42, 663, DateTimeKind.Utc).AddTicks(6442),
                            Description = "Equipos electrónicos y accesorios",
                            IsActive = true,
                            Name = "Tecnología",
                            UpdatedAt = new DateTime(2026, 3, 28, 23, 6, 42, 663, DateTimeKind.Utc).AddTicks(6443)
                        },
                        new
                        {
                            Id = new Guid("f3b8d1b6-0b3b-4b1a-9c1a-1a2b3c4d5e6f"),
                            CreatedAt = new DateTime(2026, 3, 28, 23, 6, 42, 663, DateTimeKind.Utc).AddTicks(6450),
                            Description = "Complementos y accesorios varios",
                            IsActive = true,
                            Name = "Accesorios",
                            UpdatedAt = new DateTime(2026, 3, 28, 23, 6, 42, 663, DateTimeKind.Utc).AddTicks(6451)
                        },
                        new
                        {
                            Id = new Guid("fb4c9e2c-71c4-5c2b-ac2b-2b3c4d5e6f7a"),
                            CreatedAt = new DateTime(2026, 3, 28, 23, 6, 42, 663, DateTimeKind.Utc).AddTicks(6455),
                            Description = "Prendas de vestir y calzado",
                            IsActive = true,
                            Name = "Ropa",
                            UpdatedAt = new DateTime(2026, 3, 28, 23, 6, 42, 663, DateTimeKind.Utc).AddTicks(6455)
                        });
                });
